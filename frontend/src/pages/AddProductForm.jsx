  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#fff9f6] relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute w-64 h-64 bg-purple-300 rounded-full opacity-40 top-[50px] left-[300px] animate-bounce-slow"></div>
        <div className="absolute w-72 h-72 bg-cyan-300 rounded-full opacity-40 top-[300px] right-[200px] animate-bounce-slow"></div>
        <div className="absolute w-80 h-80 bg-rose-300 rounded-full opacity-40 bottom-[150px] left-[250px] animate-bounce-slow"></div>
        <div className="absolute w-64 h-64 bg-lime-300 rounded-full opacity-40 bottom-[50px] right-[150px] animate-bounce-slow"></div>
      </div>
      {/* Form box */}
      <form
